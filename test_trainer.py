...
def RunEpoch(
    ...
    for i in range(epoch_iters):
        ...
        with timeout_guard.CompleteInTimeOrDie(timeout):
            ...
            print(img_datas)
            for k in xrange(0, args.batch_size):
                img = img_datas[k]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Caffe2: test training"
    )
    ...
    parser.add_argument("--num_epochs", type=int, default=10,#00,
                        help="Num epochs.")
    parser.add_argument("--base_learning_rate", type=float, default=0.001,
                        help="Initial learning rate.")
    parser.add_argument("--weight_decay", type=float, default=1e-4,
                        help="Weight decay (L2 regularization)")
    parser.add_argument("--cudnn_workspace_limit_mb", type=int, default=1,
    ...
    parser.add_argument("--save_model_name", type=str, default="test_model",
